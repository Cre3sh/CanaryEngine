...
int main()
{
    ...
    while (!glfwWindowShouldClose(Window))
    {
       ...
       //model = glm::rotate(model, (float)glfwGetTime() * glm::radians(50.0f), glm::vec3(0.5f, 1.0f, 0.0f));
        ...
        unsigned int modelLoc = glGetUniformLocation(EngineShaderManager.ID, "ModelMatrix");
        unsigned int viewLoc = glGetUniformLocation(EngineShaderManager.ID, "ViewMatrix");
